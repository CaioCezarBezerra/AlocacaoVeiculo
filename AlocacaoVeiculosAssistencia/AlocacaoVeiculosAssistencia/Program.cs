...
using AlocacaoVeiculosAssistencia.Middleware;
...
builder.Services.AddScoped<
    IEmpresaService,
    EmpresaAssistenciaService>();

builder.Services.AddScoped<
    IPlanoService,
    PlanoAssistenciaService>();
...
builder.Services.AddScoped<
    IVeiculoAssistenciaService,
    VeiculoAssistenciaService>();

builder.Services.AddScoped<
    IGrupoVeiculoService,
    GrupoVeiculoService>();


builder.Services.AddScoped<
    IEmpresasAssistenciaRepository,
    EmpresaAssistenciaRepository>();

builder.Services.AddScoped<
    IPlanoAssistenciaRepository,
    PlanoAssistenciaRepository>();
...
builder.Services.AddScoped<
    IVeiculoAssistenciasRepository,
    VeiculoAssistenciaRepository>();

builder.Services.AddScoped<
    IGrupoVeiculosRepository,
    GruposVeiculosRepository>();
